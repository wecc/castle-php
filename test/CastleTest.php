...
class CastleTest extends Castle_TestCase
{
    ...
    public function testTrack()
    {
        ...
        Castle::track(['name' => '$login.failed']);
    ...
    {
        Castle_RequestTransport::setResponse(204);
        $auth = Castle::identify('1', [
        'traits' => ['name' => 'Kalle Jularbo']
        ]);
    ...
    {
        Castle_RequestTransport::setResponse(204, '');
        Castle::impersonate(['user_id' => '1', 'reset' => true]);
